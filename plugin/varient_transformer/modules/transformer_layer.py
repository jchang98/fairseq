...
from ..models.transformer_config import VarientTransformerConfig
...
class TransformerEncoderLayerBase(nn.Module):
    ...
    *cfg.encoder.normalize_before* to ``True``.
    ...
    def __init__(self, cfg, return_fc=False):
        ...
        self.encoder_talking_heads = cfg.encoder_talking_heads
    ...
    def build_self_attention(self, embed_dim, cfg):
        return MultiheadAttention(      
            ...
            talking_heads = cfg.encoder_talking_heads
        )
...
class TransformerEncoderLayer(TransformerEncoderLayerBase):
    def __init__(self, args):
        super().__init__(VarientTransformerConfig.from_namespace(args))
        self.args = args

    def build_self_attention(self, embed_dim, args):
        return super().build_self_attention(
            embed_dim, VarientTransformerConfig.from_namespace(args)
        )
...
class TransformerDecoderLayerBase(nn.Module):
    ...
    *cfg.decoder.normalize_before* to ``True``.
    ...
    def __init__(
        ...
        self.decoder_talking_heads = cfg.decoder_talking_heads
    ...
    def build_self_attention(
        ...
        return MultiheadAttention(
            ...
            talking_heads=cfg.decoder_talking_heads
        )
...
class TransformerDecoderLayer(TransformerDecoderLayerBase):
    def __init__(
        ...
        super().__init__(
            VarientTransformerConfig.from_namespace(args),
