...
class MultiheadAttention(nn.Module):
    ...
    def __init__(
        ...
        talking_heads:Optional[str] = None,
    ):
        super().__init__()
        ...
        if talking_heads:
            self.pre_softmax_talking_heads = nn.Conv2d(num_heads, num_heads, 1, bias = False)
    ...
    def forward(
        ...
        if self.talking_heads:
            attn_weights = self.pre_softmax_talking_heads(attn_weights)
